...
void printUsage() {
    std::cerr << "Usage: client <wss-url> --room-dir <dir> [username] [--nickname <name>] [--key-pass <pass>] [--daemon]\n";
    std::cerr << "Commands: /image <path>, /file <path>, /voice <path>, /to <fingerprint-prefix> <text|attachment-command>, /quit\n";
    std::cerr << "Options:\n";
