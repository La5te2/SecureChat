...
void printUsage() {
    std::cerr << "Usage: client --room-dir <dir> [username] [--nickname <name>] [--key-pass <pass>] [--daemon]\n";
    std::cerr << "Commands: /nickname [name], /image <path>, /file <path>, /to <fingerprint-prefix> <text|attachment-command>, /exit\n";
    std::cerr << "Options:\n";
